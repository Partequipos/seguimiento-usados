...
const VehicleFormReal: React.FC<VehicleFormProps> = ({
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4 overflow-y-auto">
      <div className="bg-brand-white rounded-xl shadow-panel border border-brand-gray-border max-w-6xl w-full my-8 overflow-hidden">
        {/* Header */}
          ...
          <div className="flex-1">
            ...
            {isEditing && (watchedSerie || watchedModelo || watchedAsesor) && (
              <div className="flex flex-wrap items-center gap-3 mt-3">
                ...
                {watchedAsesor && (
                  <div className="inline-flex items-center gap-2 px-3 py-1.5 bg-brand-gray-soft text-brand-gray rounded-lg border border-brand-gray-border">
        ...
        <form onSubmit={handleSubmit(onSubmitForm)}>
          <div className="p-6 max-h-[60vh] overflow-y-auto">
            {currentTab === "general" ? (
              ...
              /* Pestaña de Fases */
              <div>
                <div className="mb-6 p-4 bg-brand-red-soft rounded-lg border-l-4 border-brand-red">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                  {Array.from({ length: 16 }, (_, i) => i + 1).map((num) => (
                    <div key={`F${num}`} className="bg-gray-50 p-3 rounded-lg border border-gray-200 hover:border-brand-red-muted transition-colors">
